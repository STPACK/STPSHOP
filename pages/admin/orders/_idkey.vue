      ...
      <v-col cols="5">
        <v-card>
           ...
           <v-card-title>
            ...
            <v-card-subtitle>
            {{orderList.detail.address.name}}  {{orderList.detail.address.lastName}} <br>
            {{orderList.detail.address.phone}}  {{orderList.detail.address.email}} <br>
        ...
        <v-card-actions>
          ...
          <v-row>
            <v-col>
              <v-btn  width="80%" height="40px" :color="getColor(orderList.detail.status)">{{getStatus(orderList.detail.status)}}</v-btn>
            </v-col>
            <v-col>
          ...
          v-model="status"
        ></v-select>
        <v-btn class="mx-3" color="green" dark  @click="confirm" ><v-icon dark >mdi-checkbox-marked-circle</v-icon></v-btn>
        
        <v-btn  class="mx-3" color="red" dark  @click="cancle"><v-icon dark  >mdi-cancel</v-icon></v-btn>
            </v-col>
          </v-row>
