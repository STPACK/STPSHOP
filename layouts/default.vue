  ...
  <v-app>
        ...
        <v-toolbar-items>
          <v-menu offset-y>
            <template v-slot:activator="{ on }">
              <v-btn text :disabled="!userLoggedIn" v-on="on">
                Hi {{ username }}
              </v-btn>
            </template>
            <v-list>
          ...
          <v-btn text to="/login" :hidden="userLoggedIn"
            >Login<v-icon>mdi-account-outline</v-icon></v-btn
          >
          <v-btn text @click="Logout" :hidden="!userLoggedIn"
            >Logout<v-icon>mdi-export-variant</v-icon></v-btn
          >
          <v-btn text to="/cart">
            <v-badge
    ...
    <div class="menubar">
      <v-toolbar height="48px" flat color="#ffdec9">
        ...
        <v-toolbar-items> </v-toolbar-items> </v-toolbar
      ><br />
    </div>
    <v-content>
